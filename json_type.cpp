...
int main() {
 float center[3];
 char * str = "{\"id\":\"view\",\"MaxSize\":1,\"Center\":[0, 0, 0],\"Renderers\": [{\"layer\":0,\"Background1\":[0.319997,0.340002,0.429999],\"LookAt\":[30,0,0,0,0,1,0,0,0,6.69213], \"size\": [1,1],\"origin\": [0,0]}]}";
